...
const quickActions = [
  {
    ...
    href: "/pages/clients/new", // Corrected href
    icon: PlusIcon,
      ...
      <ThemeProvider>
        ...
        <div className="min-h-screen pt-0 md:pt-30 pb-10 mb-24 px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {/* Stats Grid */}
            <motion.div
              className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 gap-6 mb-8"
              variants={itemVariants}
            >
              {loading
                ? Array.from({ length: 4 }).map((_, index) => (
                    <div
                      key={index}
                      className="glass rounded-2xl p-2 h-[100px] animate-pulse"
                    >
                ...
                : stats.map((stat) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-0">
                        <div className="p-3 pl-0 rounded-xl bg-gradient-to-r from-primary/20 to-secondary/20 text-primary">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                {quickActions.map((action) => (
                  ...
                  >
                    <Link
                      href={action.href}
                      className="block p-2 glass rounded-2xl hover:shadow-xl transition-all duration-300 group h-full"
                    >
                      <div
